...
export class InMemoryDataService implements InMemoryDbService {
  createDb():{footballs: Football[]} {
    ...
    const footballs: Football[] = [
      {id:1,playerName:"Leo Messi", playerPosition:"SecondStriker",playerJerseyNumber:10,playerAge:"three seven",isplayertrophies: true,pictureimage:"/assets/Messi.jpeg", budget: 87543},
      {id:2,playerName:"Cristiano Ronaldo", playerPosition:"CentreForward",playerJerseyNumber:7,playerAge:"three nine",isplayertrophies: true,pictureimage:"/assets/ronaldo.jpeg", budget: 88923},
      {id:3,playerName:"Ter stegan", playerPosition:"Goalkepper",playerJerseyNumber:1,playerAge:"three three",isplayertrophies: false,pictureimage:"/assets/Ter stegan.jpeg",budget: 75423},
